...
void loop(void)
{
  ...
  Serial.print("0"); // Dummy Port Number
  Serial.print(",");
  Serial.print(quat.w(), 4); // Print quaternion w
  Serial.print(",");
  Serial.print(quat.x(), 4); // Print quaternion x
  Serial.print(",");
  Serial.print(quat.y(), 4); // Print quaternion y
  Serial.print(",");
  Serial.println(quat.z(), 4); // Print quaternion z
