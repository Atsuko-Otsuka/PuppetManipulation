...
namespace OpenCVForUnityExample
{
    ...
    public class MatBasicProcessingExample : MonoBehaviour
    {
        ...
        public void OnRangeExampleButtonClick ()
        {
            ...
            // all rows
            Debug.Log ("m1.rowRange(OpenCVForUnity.Range.all())=" + m1.rowRange (OpenCVForUnity.Range.all ()).dump ());

            // rowRange(0,2)
            Debug.Log ("m1.rowRange(new OpenCVForUnity.Range(0,2))=" + m1.rowRange (new OpenCVForUnity.Range(0, 2)).dump ());

            // row(0)
            Debug.Log ("m1.row(0)=" + m1.row (0).dump ());

            // all cols
            Debug.Log ("m1.colRange(OpenCVForUnity.Range.all())=" + m1.colRange (OpenCVForUnity.Range.all ()).dump ());

            // colRange(0,2)
            Debug.Log ("m1.colRange(new OpenCVForUnity.Range(0,2))=" + m1.colRange (new OpenCVForUnity.Range(0, 2)).dump ());
            ...
            executionResultText.text = "m1=" + m1.dump () + "\n";
            executionResultText.text += "m1.rowRange(Range.all())=" + m1.rowRange (OpenCVForUnity.Range.all ()).dump () + "\n";
            executionResultText.text += "m1.rowRange(new Range(0,2))=" + m1.rowRange (new OpenCVForUnity.Range (0, 2)).dump () + "\n";
            executionResultText.text += "m1.row(0)=" + m1.row (0).dump () + "\n";
            executionResultText.text += "m1.colRange(Range.all())=" + m1.colRange (OpenCVForUnity.Range.all ()).dump () + "\n";
            executionResultText.text += "m1.colRange(new Range(0,2))=" + m1.colRange (new OpenCVForUnity.Range (0, 2)).dump () + "\n";
